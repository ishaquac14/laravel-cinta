...
@section('body')
    <div class="container">
        ...
        <div class="mb-4 text-center">
            <h5>CREATE MASTER C/S BACKUP SERVER TAPE</h5>
        </div>
        <hr>

        <form action="{{ route('tapedrive.master_store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="tape_id" id="tape_id" class="form-control mt-1" required>
            </div>
